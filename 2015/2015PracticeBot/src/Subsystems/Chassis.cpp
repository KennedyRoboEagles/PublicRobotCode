...
Chassis::Chassis() : Subsystem("Chassis") {
	this->leftSpeedController = new Jaguar(CHASSIS_LEFT_JAGUAR);
	this->rightSpeedController = new Jaguar(CHASSIS_RIGHT_JAGUAR);
	this->centerSpeedController = new Jaguar(CHASSIS_CENTER_JAGUAR);
