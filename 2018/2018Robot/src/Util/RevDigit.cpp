...
RevDigit::RevDigit() : RevDigit(BUTTON_A, BUTTON_B, POTENTIOMETER) {}

RevDigit::RevDigit(int buttonA, int buttonB, int potentiometer) {
	this->i2c = new I2C(I2C::Port::kMXP, ADDRESS);
	this->aButton = new DigitalInput(buttonA);
	this->bButton = new DigitalInput(buttonB);
