 ...
 */
public class LiftRobotLVL2Command extends Command {
  ...
  protected void execute() {
    ...
    boolean extendFront = true;
    boolean extendBack = true;
    ...
    final double kdriveBarOffset = 3;
    final double goal = 6 + kdriveBarOffset;
    if (front >= goal) {
      extendFront = false;
    }
