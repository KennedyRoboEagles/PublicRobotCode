...
package com.kennedyrobotics.drive;
...
public class DifferentialDriveHelper  {
   ...
   */
  public DifferentialDriveHelper() {
    instances++;
  }
  ...
  public DriveSignal arcadeDrive(double xSpeed, double zRotation, boolean squaredInputs) {
    ...
    return new DriveSignal(limit(leftMotorOutput) * m_maxOutput, limit(rightMotorOutput) * m_maxOutput);
  }
  ...
  public DriveSignal tankDrive(double leftSpeed, double rightSpeed, boolean squaredInputs) {
    ...
    return new DriveSignal(limit(leftSpeed) * m_maxOutput, limit(rightSpeed) * m_maxOutput);
  }
