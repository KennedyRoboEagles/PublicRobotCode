...
/**
 * 1816's Ghost Talon SRX
 * https://github.com/TheGreenMachine/Zeta/blob/develop/src/main/java/com/edinarobotics/utils/hardware/GhostTalonSRX.java
 */
public class GhostTalonSRX implements IMotorControllerEnhanced{

    private final SensorCollection sensorCollection;

    public GhostTalonSRX(int arbId) {
        Objenesis objenesis = new ObjenesisStd();
        sensorCollection = objenesis.newInstance(GhostSensorCollection.class);
    }
