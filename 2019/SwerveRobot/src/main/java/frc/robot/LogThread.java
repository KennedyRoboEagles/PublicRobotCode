...
/**
 * Badlog logger thread.
 * Note: The ROBOT_NAME system env variable needs to be set.
 * 
 * Based on FRC 1816's LogThread class.
 */
public class LogThread extends Thread {
    ...
    public synchronized void initLog(String path) {
