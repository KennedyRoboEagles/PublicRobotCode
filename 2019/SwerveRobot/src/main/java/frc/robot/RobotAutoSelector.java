 ...
 * project.
 */
public class RobotAutoSelector extends TimedRobot {
...
//    public static Drive m_drive;
    ...
    private RevDigit revDigit_;
    private AutoSelector autoSelector_;
...
//            m_drive = new Drive(RobotFactory.getInstance());
...
//            m_oi = new OI();
            ...
            revDigit_.display("Ryan");
            autoSelector_ = new AutoSelector(revDigit_, new PrintCommand("Default Auto"));
            autoSelector_.registerCommand("foo", "FOO", new PrintCommand("Foo"));
...
//            m_drive.initialize();
    ...
    public void autonomousInit() {
        ...
        try {
          ...
          autoCommand_ = autoSelector_.selected();
