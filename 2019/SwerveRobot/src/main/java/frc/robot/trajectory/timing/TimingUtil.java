...
public class TimingUtil {
    public static <S extends State<S>> Trajectory<com.team254.lib.trajectory.timing.TimedState<S>> timeParameterizeTrajectory(
            boolean reverse,
    ...
    public static <S extends State<S>> Trajectory<com.team254.lib.trajectory.timing.TimedState<S>> timeParameterizeTrajectory(
        ...
        List<com.team254.lib.trajectory.timing.TimedState<S>> timed_states = new ArrayList<>(states.size());
        double t = 0.0;
        double s = 0.0;
        double v = 0.0;
        for (int i = 0; i < states.size(); ++i) {
